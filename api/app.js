...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        let response_payload = await invoke.invokeTransaction(channelName, chaincodeName, fcn, args, req.username, req.orgname);
...
app.get('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        // console.log(`Memory Usage--------: ${JSON.stringify(usage)}`)
        ...
        // console.log(`app.js Error data in CatchBlock: ${response_payload.errorData}`)
        res.send(response_payload)
    }
});
